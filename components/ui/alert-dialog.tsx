...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn('surface-overlay fixed inset-0 z-50', className)}
    {...props}
    ref={ref}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn('fixed left-[50%] top-[50%] z-50 w-full max-w-md translate-x-[-50%] translate-y-[-50%] rounded-xl border border-gray-200 bg-white shadow-xl p-6', className)}
      {...props}
    />
  </AlertDialogPortal>
));
