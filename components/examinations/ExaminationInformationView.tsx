  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        <ResponsiveTable showHint={false} contained>
...
export function ExaminationInformationView(_props: ExaminationInformationViewProps) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <PageMain flexContent noScroll className="flex min-h-0 flex-1 flex-col">
        <div className="directory-root min-h-0 flex-1">
